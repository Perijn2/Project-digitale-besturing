...
--
-- Created:
--          by - bouma.UNKNOWN (LAPTOP_DIRK)
--          at - 12:04:33 03/03/2025
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2022.1 Built on 21 Jan 2022 at 13:00:30
--
LIBRARY ieee;
...
BEGIN
   ...
   BEGIN
      CASE current_state IS
         WHEN s0 => 
            IF (go_verwarmen = '1' AND w_laag = '0') THEN 
               next_state <= s1;
            ELSIF (go_verwarmen = '0' OR w_laag = '1') THEN 
               next_state <= s0;
            ELSE
               next_state <= s0;
            END IF;
         WHEN s1 => 
            IF (t_hoog = '1' OR w_laag = '1') THEN 
               next_state <= s0;
            ELSIF (t_hoog = '0') THEN 
               next_state <= s1;
            ELSE
