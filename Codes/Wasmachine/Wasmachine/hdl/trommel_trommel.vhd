...
BEGIN
   ...
   BEGIN
      ...
      CASE current_state IS
         ...
         WHEN links_200 => 
            ...
            csm_to_s5 <= '1';
         WHEN s6 => 
            IF (csm_timeout = '1' AND (Richting = '1')) THEN 
               next_state <= rechts_201;
            ELSIF (csm_timeout = '1' AND (Richting = '0')) THEN 
               next_state <= links_200;
            ELSIF (csm_timeout = '1' AND (Revoluties >= 20)) THEN 
               next_state <= s7;
            ELSE
               next_state <= s6;
            END IF;
   ...
   BEGIN
      ...
      ELSIF (csm_to_s6 = '1') THEN
         csm_next_timer <= "001001"; -- no cycles(10)-1=9
      ELSIF (csm_to_s5 = '1') THEN
         csm_next_timer <= "110001"; -- no cycles(50)-1=49
