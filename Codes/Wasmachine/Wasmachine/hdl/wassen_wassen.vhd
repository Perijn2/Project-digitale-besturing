   ...
   BEGIN
      CASE current_state IS
         ...
         WHEN s3 => 
            next_state <= s8;
         WHEN keuze => 
            IF (programmakeuze = "01" AND go_wassen = '1') THEN 
               next_state <= s8;
            ELSE
               next_state <= keuze;
            END IF;
         ...
         WHEN s19 => 
            ...
            END IF;
         WHEN keuze2 => 
            IF ((centrifugeerkeuze = "01" OR centrifugeerkeuze = "10") AND go_wassen = '1') THEN 
               next_state <= centr_0;
            ELSE
               next_state <= keuze2;
            END IF;
