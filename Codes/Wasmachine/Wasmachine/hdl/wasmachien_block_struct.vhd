...
ARCHITECTURE struct OF wasmachien_block IS
   ...
   SIGNAL afpompen_ready      : std_logic;
   SIGNAL centrifugeren_ready : std_logic;
   SIGNAL go_afmpompen        : std_logic;
   SIGNAL go_centrifugeren    : std_logic;
   SIGNAL go_toevoer          : std_logic;
   SIGNAL go_trommel          : std_logic;
   SIGNAL go_verwarmen        : std_logic;
   SIGNAL go_wassen           : std_logic;
   SIGNAL toevoer_ready       : std_logic;
   SIGNAL trommel_ready       : std_logic;
   SIGNAL verwarmen_ready     : std_logic;
   SIGNAL wassen_ready        : std_logic;
   SIGNAL wassen_status       : std_logic_vector(2 DOWNTO 0);
   ...
   PORT (
      aan_uit        : IN     std_logic ;
      clk            : IN     std_logic ;
      go_afmpompen   : IN     std_logic ;
      kuip_leeg      : IN     std_logic ;
      afpompen_ready : OUT    std_logic ;
      pomp_aan       : OUT    std_logic 
   );
   END COMPONENT;
   COMPONENT Centrifugeren
   PORT (
      aan_uit             : IN     std_logic ;
      clk                 : IN     std_logic ;
      go_centrifugeren    : IN     std_logic ;
      trommel_ready       : IN     std_logic ;
      centrifugeren_ready : OUT    std_logic ;
   ...
   FOR ALL : Centrifugeren USE ENTITY Wasmachine.Centrifugeren;
...
BEGIN
   ...
   U_4 : Centrifugeren
      PORT MAP (
         aan_uit             => aan_uit,
         clk                 => clk,
         go_centrifugeren    => go_centrifugeren,
         trommel_ready       => trommel_ready,
         centrifugeren_ready => centrifugeren_ready,
