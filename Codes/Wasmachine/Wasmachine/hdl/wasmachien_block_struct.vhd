...
ARCHITECTURE struct OF wasmachien_block IS
   ...
   SIGNAL trommel_keuze   : std_logic;
   ...
   PORT (
      ...
      w_hoog            : IN     std_logic ;
      w_laag            : IN     std_logic ;
      go_afpompen       : OUT    std_logic                     := '0';
      go_toevoer        : OUT    std_logic                     := '0';
      go_trommel        : OUT    std_logic                     := '0';
      go_verwarmen      : OUT    std_logic                     := '0';
      trommel_keuze     : OUT    std_logic                     := '0';
      wassen_ready      : OUT    std_logic                     := '0';
      wassen_status     : OUT    std_logic_vector (2 DOWNTO 0) := "000"
   );
   END COMPONENT;
